  ...
  return (
    <div className='flex flex-col items-center gap-4'>
      ...
      <ol className='lg:w-[50%] w-[90%] flex flex-col items-center '>
        ...
        {pin.completed === true ? <p className='text-sm text-green-400'>Approved</p> : <p className='text-sm text-red-400'>Not Approved</p>}
      </div>
      {pin.completed === true ? <DisButton data={pin} /> : <Button data={pin} />}
      </div>
    </div>
  )
}
